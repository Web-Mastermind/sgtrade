      ...
      <div className="container">
        <div className={styles.sendItems}>
          ...
          <form className={styles.sendForm} action="https://getform.io/f/68f52048-e379-44ba-91d0-67dd3e8261d2" method="POST">
            <input className={`${styles.sendInput} ${styles.colorBlack} ${styles.colorWhite}`} type="email" name="email" placeholder="Email" required />
            <input className={`${styles.sendInput} ${styles.colorBlack} ${styles.colorWhite}`} type="tel" name="tel" placeholder="Telefon" required />
            <input className={`${styles.sendInput} ${styles.colorBlack} ${styles.colorWhite}`} type="text" name="text" placeholder="Şirkət" required />
